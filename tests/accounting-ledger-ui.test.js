...
assert.match(server, /refreshTournamentSheetV2ByEntryId_\(String\(result\.entry_id\)\)/);
assert.match(server, /partial:\s*true/);
assert.match(server, /大会シートの書戻しに失敗/);
...
assert.match(taikai, /function taikaiRecordFullPaymentByPlayer_/);
