...
var HELP_DEFAULT_ROWS_  = [
  ['calendar',        '大会一覧',       '「完了」ボタンについて',     '「完了」を押すと大会が一覧から非表示になります。メール履歴・支払い履歴は削除されません。'],
  ...
  ['suitou',          '出納管理',       '使い方',                     '大会詳細で「済」を入力すると、対象の申込IDへ支払い履歴が記録されます。'],
  ['suitou',          '出納管理',       '使い方',                     '大会一覧の「振込済」は主催者への送金完了状態です。選手の支払い・デポジット履歴は変更しません。'],
  ['suitou',          '出納管理',       '使い方',                     '請求額・支払済額・残額はDBの履歴から表示します。大会シートから会計履歴を再生成しません。'],
